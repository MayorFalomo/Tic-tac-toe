...
export const globalChatStyle = "bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 hover:from-gray-800 hover:via-purple-800 hover:to-gray-800 border border-purple-900/30 shadow-[0_0_10px_rgba(88,28,135,0.15)] hover:shadow-[0_0_15px_rgba(88,28,135,0.25)] transition-all duration-300 text-purple-100 font-semibold text-lg backdrop-blur-sm"