...
const Settings = () => {
  ...
  const handleNotifBgChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <FadeIn>
      ...
      >
        ...
        >
          <div className="ml-5 max-[400px]:ml-3 mt-4">
            <Link href="/">
              <span>{<ArrowLeft />} </span>
            </Link>
          </div>
          ...
          <div className="flex justify-between items-center w-[90%] mx-auto mt-[30px]">
